    ...
    <div class="main">
        ...
        <div class="temp">
            ...
            <form action="index.php" method="get">
                <span>
                    <p>Aktueller Stand</p>
                    <label>Temperatur: </label>     <input type="text" id="Temp" name="Temperatur" value="<?echo $temperatur;?>" /> <br/>
                    <label>Licht:       </label>    <input type="text" id="Licht" name="Licht"     value="<?echo $light;?>" />    <br/>
                    <label>Pumpe:       </label>    <input type="text" id="Pumpe" name="Pumpe     "value="<?echo $pump;?>" />    <br/>
                    <label>Heizung:     </label>    <input type="text" id="Heizung" name="Heizung "value="<?echo $heating;?>" />    <br/>
                </span> 
                <br>
            ...
            <form action = "\light_onoff.php" method="get">
                <span>
                   <p> Unter der Woche <br/></p>
                    <label>An1:       </label>    <input type="time" name="weekOn1" id="weekOn1"    value="<? echo $weekAn1;?>" /></br>
                    <label>Aus1:      </label>    <input type="time" name="weekOff1" id="weekOff1"  value="<? echo $weekOff1;?>" /></br>
                    <br>
                    <label>An2:       </label>    <input type="time" name="weekOn2" id="weekOn2"    value="<? echo $weekAn2;?>"  /></br>
                    <label>Aus2:      </label>    <input type="time" name="weekOff2" id="weekOff2"  value="<? echo $weekOff2;?>" /></br>
                </span>
                <span>
                    <p>Wochenende</p>
                    <label>An1:          </label>    <input type="time" name="weekEndOn1" id="weekEndOn1" value="<? echo $weekendAn1;?>" /><br>
                    <label>Aus1:         </label>    <input type="time" name="weekEndOff1" id="weekEndOff1" value="<? echo $weekendOff1;?>" /><br>
                    <br>
                    <label>An2:          </label>    <input type="time" name="weekEndOn2" id="weekEndOn2" value="<? echo $weekendAn2;?>"/><br>
                    <label>Aus2:         </label>    <input type="time" name="weekEndOff2" id="weekEndOff2"value="<? echo $weekendOff2;?>" /><br>
                </span>
                </br>
                <input type = "submit">
            </from>
